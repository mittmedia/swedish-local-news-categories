...
def load_categories():
    with open('src/categories-coded.yml', 'r') as categories_file:
...
def save_categories(categories):
    with open('src/categories-coded.yml', 'w') as categories_file:
        yaml.dump(categories, categories_file)

def load_modfile():
    with open('diff-example.yml', 'r') as modfile:
...
if __name__ == '__main__':
    ...
    save_categories(update_categories(categories,modifications))
